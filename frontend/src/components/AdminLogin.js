...
export default function AdminLogin() {
    ...
    const { openPopUp, setopenPopUp, PopUpMessage,setPopUpMessage,setid } =  useContext(MainContext)



    const signIn = () => {
        setisLoading(true)
        axios.post('http://localhost:3001/adminLogin',{email,password}).then((res)=>{
            setisLoading(false)
            ...
            <div className='CentralPart1'>
                ...
                <div className='LoginSection'>
                    ...
                    <div className='LoginPart'>
                        ...
                        <p>Dont have an Account ? <span onClick={()=>navigate('/adminsignup')} style={{cursor:"pointer",color:"green",fontWeight:"bold"}}>SignUp</span></p>
